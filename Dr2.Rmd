...
kable(tibble("Payable to SB" = "(0.33 * OHIP Clinic) + (0.5 * OHIP Test) - (0.67 * Direct Clinic) - (0.5 * Direct Test) - (Direct Dr.2)"))
kable(tibble("Payable to SB" =
