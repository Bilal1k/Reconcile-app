...
direct <- read_csv(params$direct3, skip = 2)
...
kable(tibble("Payable to SB" = "(0.35 * OHIP Clinic) + (0.5 * OHIP VF) - (0.65 * Direct Clinic) - (0.5 * Direct VF) - (Direct Dr3)"))
